...
router.get('/roles/:idrole/permissions', authMiddleware, AuthManagementController.getRolePermissions);
router.post('/roles/permissions', authMiddleware, AuthManagementController.saveRolePermissions);
